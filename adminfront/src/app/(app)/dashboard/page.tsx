  ...
  return (
    <div className="space-y-6">
      <header className="rounded-[1.75rem] border border-slate-900/10 bg-white p-6">
        ...
        <p className="mt-2 text-sm text-slate-600">Manage organizations, marketplaces, and users.</p>
      </header>
      <section className="grid gap-4 md:grid-cols-3">
        {[
          { label: "Users", value: "Soon" },
          { label: "Organizations", value: "Soon" },
          { label: "Marketplaces", value: "Soon" },
        ].map((card) => (
