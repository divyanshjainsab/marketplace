...
import type { Category, Marketplace, PaginatedResponse, Product, ProductType } from "@/lib/types";
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
      <section className="rounded-[1.75rem] border border-slate-900/10 bg-white p-5">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-sm outline-none focus:border-slate-900 md:max-w-sm"
          />
        </div>
      ...
      <section className="rounded-[1.75rem] border border-slate-900/10 bg-slate-50 p-5">
        <p className="text-xs uppercase tracking-[0.25em] text-slate-500">Create product</p>
        <h2 className="mt-2 text-xl font-semibold text-slate-950">Add to the shared catalog</h2>
